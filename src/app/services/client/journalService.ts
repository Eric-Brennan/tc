// ============================================================
// Client Journal Service
// ============================================================
// GET    /journal                 -> list journal entries for a client
// GET    /journal/:id             -> get entry by ID
// POST   /journal                 -> create journal entry
// PUT    /journal/:id/sharing     -> update sharing preferences
// DELETE /journal/:id             -> delete journal entry
// Note: Journal entries are typically immutable (no general update)
// ============================================================
...
export async function deleteJournalEntry(
  ...
  if (idx === -1) return notFound('JournalEntry');
